...
class Employee(TimestampMixin, Base):
    ...
    aadhar_url: Mapped[Optional[str]] = mapped_column(String(500))
    pan_url: Mapped[Optional[str]] = mapped_column(String(500))
    passbook_url: Mapped[Optional[str]] = mapped_column(String(500))
