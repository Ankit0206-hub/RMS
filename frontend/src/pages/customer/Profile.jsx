        ...
        <PageLayout className="bg-gray-50">
            <div className="flex h-full flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-5 pb-32">
                    ...
                    {/* Details Form / View */}
                    <div className="bg-white rounded-[1.5rem] shadow-[0_2px_10px_rgba(0,0,0,0.02)] p-6 space-y-5">
                    ...
                    {isEditing && (
                        <div className="flex items-center gap-4 mt-10">
                            <button 
                                ...
                                className="flex-1 h-14 sm:h-16 bg-white border-2 border-gray-100 text-gray-600 font-bold text-[16px] sm:text-[17px] rounded-2xl active:scale-97 transition-transform flex items-center justify-center gap-2"
                            >
