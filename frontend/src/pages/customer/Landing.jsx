...
export default function Landing() {
  ...
  return (
    <PageLayout className="relative bg-black overflow-hidden h-[100dvh] w-full">
      ...
      <div className="relative z-10 flex h-full flex-col p-6 py-8 md:p-12 overflow-hidden">
        
        {/* Branding */}
        <div className="mt-2 md:mt-8 flex flex-col items-center justify-center">
        ...
        {/* Features */}
        <div className="flex justify-between px-2 max-w-sm md:max-w-3xl mx-auto w-full gap-4 md:gap-12">
        ...
        {/* Action Button */}
        <div className="pb-2 pt-8 md:pt-12 w-full max-w-sm md:max-w-md mx-auto">
          <button
