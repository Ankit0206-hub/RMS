    ...
    <PageLayout className="bg-white">
      <div className="relative flex h-full flex-col">
        ...
        <div className="absolute bottom-0 left-0 right-0 border-t border-gray-100 bg-white p-4 pb-6 shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.1)] rounded-t-3xl z-10 flex items-center gap-4">
          {/* Quantity Selector */}
          <div className="flex items-center gap-4 rounded-2xl border border-gray-200 px-4 py-3 bg-white">
            <button 
          ...
          <button
            ...
            className="flex-1 flex h-14 items-center justify-between rounded-2xl bg-orange-500 px-6 font-bold text-white shadow-lg shadow-orange-200 transition hover:bg-orange-600 active:scale-[0.98]"
          >
