...
const defaultImages = [
  ...
  "https://images.unsplash.com/photo-1633945274405-b6c8069047b0?w=200&q=80",
  ...
  return (
    <PageLayout className="bg-slate-50">
      <div className="flex h-full flex-col">
        {/* Header */}
        <div className="relative flex items-center justify-center px-4 md:px-8 pt-6 pb-4 z-10  mx-auto w-full">
        ...
        {/* Search Bar */}
        <div className="px-4 md:px-8 pb-5  mx-auto w-full">
        ...
        {/* List / Grid Layout */}
        <div className="flex-1 overflow-y-auto px-4 md:px-8 pb-24  mx-auto w-full">
              ...
              >
                <div className="flex items-center gap-4 md:gap-5">
                  <div className="h-[72px] w-[96px] md:h-[90px] md:w-[120px] overflow-hidden rounded-2xl md:rounded-3xl bg-orange-50 shrink-0 shadow-inner">
                    <img
                      src={defaultImages[filteredCategories.indexOf(cat) % defaultImages.length]}
                      alt={cat.name}
