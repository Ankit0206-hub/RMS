...
export default function WaiterOrderHistory() {
 ...
 <button onClick={() => navigate('/waiter/profile')} className="p-2 text-gray-700 bg-white/20 rounded-full border border-white/40 transition-colors mr-3 shadow-sm">
 ...
 Table {tableId ||'T01'} - Rahul Sharma
 </div>
 ...
 <span className="text-sm md:text-base font-bold text-gray-600 uppercase tracking-wide">Total Amount</span>
 ...
 <button onClick={() => toast.success('Bill request sent to kitchen/operator!')} className="w-full bg-white/30 backdrop-blur-md text-rose-600 border-2 border-rose-300 rounded-[18px] py-4 font-bold text-[15px] md:text-lg shadow-sm active:scale-[0.98] transition-all flex items-center justify-center">
