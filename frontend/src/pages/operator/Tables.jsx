...
const Tables = () => {
    ...
    return (
        <div className="flex h-full font-inter overflow-hidden bg-[#F8F9FB]">
                ...
                <div className="overflow-y-auto flex-1 scrollbar-hide space-y-4">
                    ...
                    <div className="flex justify-between items-end">
                        <div>
                            <div className="flex items-center text-[13px] font-medium text-gray-500 mb-2">
                                ...
                                <ChevronRight size={14} className="mx-1" />
                                <span className="text-gray-900 font-bold">Tables</span>
                            </div>
                            <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Restaurant / Tables</h2>
                        </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4">
                        <div className="bg-white rounded-xl border border-gray-100 p-4 flex items-center shadow-sm">
                            ...
                            <div>
                                <p className="text-[11px] font-semibold text-gray-500 uppercase">Total Tables</p>
                                <h4 className="text-xl font-bold text-gray-900 mt-0.5">{totalTables}</h4>
                        ...
                        <div className="bg-white rounded-xl border border-gray-100 p-4 flex items-center shadow-sm">
                            ...
                            <div>
                                <p className="text-[11px] font-semibold text-gray-500 uppercase">Available</p>
                                <h4 className="text-xl font-bold text-gray-900 mt-0.5">{available}</h4>
                        ...
                        <div className="bg-white rounded-xl border border-gray-100 p-4 flex items-center shadow-sm">
                            ...
                            <div>
                                <p className="text-[11px] font-semibold text-gray-500 uppercase">Occupied</p>
                                <h4 className="text-xl font-bold text-gray-900 mt-0.5">{occupied}</h4>
                        ...
                        <div className="bg-white rounded-xl border border-gray-100 p-4 flex items-center shadow-sm">
                            ...
                            <div>
                                <p className="text-[11px] font-semibold text-gray-500 uppercase">Reserved</p>
                                <h4 className="text-xl font-bold text-gray-900 mt-0.5">{reserved}</h4>
                        ...
                        <div className="bg-white rounded-xl border border-gray-100 p-4 flex items-center shadow-sm">
                            ...
                            <div>
                                <p className="text-[11px] font-semibold text-gray-500 uppercase">Cleaning</p>
                                <h4 className="text-xl font-bold text-gray-900 mt-0.5">{cleaning}</h4>
                        ...
                        <div className="bg-white rounded-xl border border-gray-100 p-4 flex items-center shadow-sm">
                            ...
                            <div>
                                <p className="text-[11px] font-semibold text-gray-500 uppercase">Out of Service</p>
                                <h4 className="text-xl font-bold text-gray-900 mt-0.5">{outOfService}</h4>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col">
                        <div className="p-4 border-b border-gray-100 flex flex-wrap gap-4 items-center justify-between rounded-t-2xl">
                            <div className="relative flex-1 min-w-[200px] max-w-md">
                                ...
                                <input 
                                    ...
                                    className="w-full pl-9 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-xs font-medium focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all"
                                />
                            </div>
                            ...
                            <div className="flex flex-wrap items-center gap-3">
                                <div>
                                    ...
                                    <select className="border border-gray-200 text-xs font-semibold rounded-lg px-3 py-2 bg-white outline-none min-w-[130px]">
                                ...
                                <button className="mt-4 flex items-center px-4 py-2 border border-gray-200 bg-white text-gray-700 text-xs font-bold rounded-lg hover:bg-gray-50 transition-colors">
                                    <Filter size={14} className="mr-2" /> Filters
                                </button>
                                <button onClick={() => refetch()} className="mt-4 flex items-center px-4 py-2 border border-gray-200 bg-white text-gray-700 text-xs font-bold rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left text-xs whitespace-nowrap">
                                <thead>
                                    <tr className="bg-white border-b border-gray-100 text-[10px] uppercase font-bold text-gray-500 tracking-wider">
                                ...
                                <tbody>
                                    {filteredTables.map((table) => {
                                        ...
                                        return (
                                            <tr key={table.id} className="border-b border-gray-50 last:border-0 hover:bg-gray-50/50 transition-colors">
                                                <td className="px-5 py-3.5">
                                                    <span className="font-bold text-gray-900 text-[13px]">{table.table_number}</span>
                                                </td>
                                                ...
                                                <td className="px-5 py-3.5">
                                                    {table.assigned_waiter_name ? (
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="font-semibold text-gray-800">{table.assigned_waiter_name}</span>
                                                        </div>
                                                    ) : (
                                                        <span className="text-gray-400 font-medium">-</span>
                                                    )}
                                                </td>
                                                <td className="px-5 py-3.5 text-center font-semibold text-gray-600">
            ...
            <div className={`fixed top-0 right-0 h-full w-full sm:w-[380px] bg-white border-l border-gray-100 shadow-2xl transform transition-transform duration-300 ease-in-out z-20 ${selectedTable ? 'translate-x-0' : 'translate-x-full'}`}>
                {selectedTable && (
                    <div className="h-full flex flex-col">
                        <div className="flex items-center justify-between p-6 border-b border-gray-100 shrink-0">
                            <h3 className="text-lg font-bold text-gray-900">Table Details</h3>
                            <button onClick={() => setSelectedTable(null)} className="text-gray-400 hover:text-gray-600 hover:bg-gray-100 p-1.5 rounded-lg transition-colors">
                                <X size={20} />
                            </button>
                        </div>
                        ...
                        <div className="p-6 overflow-y-auto flex-1 space-y-6">
                            ...
                            <div className="flex items-center">
                                ...
                                <div>
                                    <div className="flex items-center">
                                        <h2 className="text-2xl font-black text-gray-900 leading-tight mr-3">{selectedTable.table_number}</h2>
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center text-sm">
                                    <div className="flex items-center text-gray-500 font-semibold"><Map size={14} className="mr-2" /> Section</div>
                                    <div className="font-bold text-gray-900">{selectedTable.floor || 'Main Hall'}</div>
                                </div>
                                <div className="flex justify-between items-center text-sm">
                                    <div className="flex items-center text-gray-500 font-semibold"><Users size={14} className="mr-2" /> Capacity</div>
                                    <div className="font-bold text-gray-900">{selectedTable.capacity} Seats</div>
                                </div>
                                <div className="flex justify-between items-center text-sm">
                                    <div className="flex items-center text-gray-500 font-semibold"><CheckCircle2 size={14} className="mr-2" /> Status</div>
                                    <div className={`font-bold ${getStatusColor(selectedTable.status).text}`}>{selectedTable.status}</div>
                                </div>
                                <div className="flex justify-between items-center text-sm">
                                    <div className="flex items-center text-gray-500 font-semibold"><Users size={14} className="mr-2" /> Assigned Waiter</div>
                                    <div className="font-bold text-gray-900">{selectedTable.assigned_waiter_name || 'Not Assigned'}</div>
                                </div>
                                <div className="flex justify-between items-center text-sm">
                                    <div className="flex items-center text-gray-500 font-semibold"><Users size={14} className="mr-2" /> Current Guests</div>
                                    <div className="font-bold text-gray-900">{selectedTable.status === 'Occupied' ? (selectedTable.capacity - 1) : 0}</div>
                                </div>
                                <div className="flex justify-between items-center text-sm">
                                    <div className="flex items-center text-gray-500 font-semibold"><Clock size={14} className="mr-2" /> Current Orders</div>
                                    <div className="font-bold text-gray-900">{selectedTable.current_order_id ? 1 : 0}</div>
                                </div>
                                <div className="flex justify-between items-center text-sm">
                                    <div className="flex items-center text-gray-500 font-semibold"><Edit2 size={14} className="mr-2" /> Notes</div>
                            ...
                            <div className="pt-4 border-t border-gray-100">
                                <h4 className="text-[11px] font-bold text-gray-900 mb-3">Quick Actions</h4>
                                <div className="space-y-2.5">
                                    <button className="w-full flex items-center px-4 py-2 border border-gray-200 rounded-lg text-xs font-semibold text-indigo-600 hover:bg-indigo-50 transition-colors">
                                        <Edit2 size={14} className="mr-3 text-indigo-600" /> Edit Table
                                    </button>
                                    <button className="w-full flex items-center px-4 py-2 border border-gray-200 rounded-lg text-xs font-semibold text-orange-600 hover:bg-orange-50 transition-colors">
                                        <RefreshCcw size={14} className="mr-3 text-orange-600" /> Change Status
                                    </button>
                                    <button className="w-full flex items-center px-4 py-2 border border-gray-200 rounded-lg text-xs font-semibold text-red-600 hover:bg-red-50 transition-colors">
