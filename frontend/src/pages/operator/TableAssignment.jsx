...
const TableAssignment = () => {
    ...
    if (tablesLoading || employeesLoading) return <div className="p-8 text-center text-gray-500 dark:text-slate-400 font-inter text-[15px] font-bold">Loading Floor Data...</div>;
        ...
        <div className="space-y-6 pb-12 font-inter">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4">
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-800 p-4 shadow-sm flex items-center">
                    ...
                    <div>
                        <p className="text-[11px] font-semibold text-gray-500 dark:text-slate-400 uppercase mb-0.5">Total Tables</p>
                        <h4 className="text-[22px] font-bold text-gray-900 dark:text-white leading-tight">{totalTables}</h4>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-800 p-4 shadow-sm flex items-center">
                    ...
                    <div>
                        <p className="text-[11px] font-semibold text-gray-500 dark:text-slate-400 uppercase mb-0.5">Assigned Tables</p>
                        <h4 className="text-[22px] font-bold text-gray-900 dark:text-white leading-tight">{assignedTables}</h4>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-800 p-4 shadow-sm flex items-center">
                    ...
                    <div>
                        <p className="text-[11px] font-semibold text-gray-500 dark:text-slate-400 uppercase mb-0.5">Unassigned Tables</p>
                        <h4 className="text-[22px] font-bold text-gray-900 dark:text-white leading-tight">{unassignedTables}</h4>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-800 p-4 shadow-sm flex items-center">
                    ...
                    <div>
                        <p className="text-[11px] font-semibold text-gray-500 dark:text-slate-400 uppercase mb-0.5">Active Waiters</p>
                        <h4 className="text-[22px] font-bold text-gray-900 dark:text-white leading-tight">{activeWaiters}</h4>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-800 p-4 shadow-sm flex items-center">
                    ...
                    <div>
                        <p className="text-[11px] font-semibold text-gray-500 dark:text-slate-400 uppercase mb-0.5">Available Waiters</p>
                        <h4 className="text-[22px] font-bold text-gray-900 dark:text-white leading-tight">{availableWaiters}</h4>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-800 p-4 shadow-sm flex items-center">
                    ...
                    <div>
                        <p className="text-[11px] font-semibold text-gray-500 dark:text-slate-400 uppercase mb-0.5">Current Shift</p>
                        <h4 className="text-[15px] font-bold text-gray-900 dark:text-white leading-tight whitespace-nowrap mt-1">Morning Shift</h4>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-6 bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm flex flex-col">
                    <div className="p-5 border-b border-gray-100 dark:border-slate-800 shrink-0">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-[15px] font-bold text-gray-900 dark:text-white flex items-center cursor-pointer">
                                Restaurant Floor (Main Hall) <ChevronDown size={16} className="ml-2 text-gray-400" />
                            </h3>
                        </div>
                        <div className="flex items-center gap-4 text-[10px] font-bold uppercase tracking-wider text-gray-500 dark:text-slate-400">
                                ...
                                return (
                                    <div 
                                        ...
                                        className={`relative border rounded-xl p-3 flex flex-col items-center justify-center text-center cursor-pointer transition-all ${
                                            ...
                                            isUnassigned ? 'border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/50/50 hover:border-gray-300 dark:border-slate-600' : 
                                            `${statusColors.border} hover:shadow-md`
                                        }`}
                                    >
                                        <h4 className="text-[15px] font-bold text-gray-900 dark:text-white">{table.table_number}</h4>
                                        <p className="text-[10px] text-gray-500 dark:text-slate-400 font-medium mt-0.5">{table.capacity} Seats</p>
                                        
                                        <div className={`text-[11px] font-bold mt-2 mb-2 ${statusColors.text}`}>
                                            {table.status}
                                        </div>
                                        
                                        <div className={`flex items-center justify-center text-[11px] font-bold w-full truncate ${isUnassigned ? 'text-gray-400' : 'text-gray-700 dark:text-slate-300'}`}>
                    ...
                    <div className="p-4 border-t border-gray-100 dark:border-slate-800 flex items-center justify-between shrink-0 bg-gray-50 dark:bg-slate-800/50/50 rounded-b-2xl text-[11px] font-semibold text-gray-600 dark:text-slate-400">
                ...
                <div className="lg:col-span-3 flex flex-col space-y-6">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm flex flex-col">
                        <div className="p-5 border-b border-gray-100 dark:border-slate-800 shrink-0">
                            <h3 className="text-[15px] font-bold text-gray-900 dark:text-white mb-4">Waiters ({waiters.length})</h3>
                            <div className="flex items-center space-x-2">
                                <div className="relative flex-1">
                                    ...
                                    <input 
                                        ...
                                        className="w-full pl-9 pr-3 py-2 bg-gray-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 rounded-lg text-[13px] focus:outline-none focus:border-indigo-500"
                                    />
                                </div>
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center justify-between mb-0.5">
                                                <h4 className="text-[13px] font-bold text-gray-900 dark:text-white truncate pr-2">{waiter.full_name}</h4>
                                                <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded-full ${statusClass}`}>{statusText}</span>
                                            </div>
                                            <p className="text-[11px] text-gray-500 dark:text-slate-400 truncate">{workload} Tables • Main Hall</p>
                                        </div>
                                    </div>
                                );
                            })}
                    ...
                    {/* Assign Panel */}
                    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm p-5 shrink-0 flex flex-col h-[326px]">
                        <h3 className="text-[15px] font-bold text-gray-900 dark:text-white mb-4 flex items-center"><User size={16} className="mr-2 text-indigo-500"/> Assign Table</h3>
                        
                        <div className="mb-4">
                            <p className="text-[11px] font-semibold text-gray-500 dark:text-slate-400 mb-2">Selected Table</p>
                            <div className="bg-gray-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 rounded-xl p-3 flex justify-between items-center">
                                <div>
                                    <div className="flex items-center">
                                        <h4 className="text-[18px] font-black text-gray-900 dark:text-white mr-3">{selectedTable ? selectedTable.table_number : 'None'}</h4>
                                        <span className="text-[10px] font-bold bg-gray-200 text-gray-600 dark:text-slate-400 px-2 py-0.5 rounded-full">{selectedTable?.assigned_waiter_id ? 'Assigned' : 'Unassigned'}</span>
                                    </div>
                                    <p className="text-[11px] font-semibold text-gray-500 dark:text-slate-400 mt-1">Capacity: {selectedTable?.capacity || '-'} Seats</p>
                                </div>
                                <div className="text-right">
                                    <p className="text-[10px] text-gray-400 font-semibold mb-1">Status</p>
                                    <p className="text-[11px] font-bold text-gray-800 dark:text-slate-200">{selectedTable?.status || '-'}</p>
                                </div>
                            </div>
                        </div>

                        <div className="mb-4">
                            <p className="text-[11px] font-semibold text-gray-500 dark:text-slate-400 mb-2">Assign To Waiter</p>
                            <select 
                        ...
                        <div className="mt-auto space-y-2">
                            ...
                            <button className="w-full flex items-center justify-center text-gray-500 dark:text-slate-400 hover:text-indigo-600 font-semibold text-[11px] py-2">
                ...
                <div className="lg:col-span-3 space-y-6">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm p-5">
                        <h3 className="text-[15px] font-bold text-gray-900 dark:text-white mb-4">Floor Summary</h3>
                        ...
                        <div className="flex items-center mb-6">
                            ...
                            <div className="space-y-3 flex-1">
                                <div className="flex items-center text-[11px] font-bold text-gray-600 dark:text-slate-400">
                        ...
                        <div className="pt-4 border-t border-gray-100 dark:border-slate-800">
                            <div className="flex justify-between items-center mb-3">
                                <h4 className="text-[13px] font-bold text-gray-800 dark:text-slate-200">Unassigned Tables ({unassignedTables})</h4>
                            ...
                            <div className="space-y-2 max-h-[120px] overflow-y-auto pr-1">
                                {tables.filter(t => !t.assigned_waiter_id).slice(0, 6).map(table => (
                                    <div key={table.id} className="flex justify-between items-center text-[11px]">
                                        ...
                                        <span className="bg-gray-100 dark:bg-slate-800 text-gray-500 dark:text-slate-400 px-2 py-0.5 rounded text-[10px] font-bold">Unassigned</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm p-5">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-[15px] font-bold text-gray-900 dark:text-white">Waiter Workload</h3>
                            <button className="text-[10px] font-bold text-indigo-600 hover:underline">View All</button>
                        </div>
                        <div className="space-y-4 max-h-[160px] overflow-y-auto pr-2">
                            {waiterWorkload.slice(0, 5).map(waiter => {
                                ...
                                return (
                                    <div key={waiter.id}>
                                        <div className="flex justify-between items-center text-[11px] font-bold text-gray-700 dark:text-slate-300 mb-1">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm p-5">
                        ...
                        <div className="space-y-2">
                            <button className="w-full flex items-center justify-center p-2.5 border border-gray-200 dark:border-slate-700 rounded-xl text-[11px] font-bold text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-800 dark:bg-slate-800/50 transition-colors">
