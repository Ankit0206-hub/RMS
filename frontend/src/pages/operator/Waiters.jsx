...
const Waiters = () => {
    ...
    if (employeesLoading || tablesLoading) {
        return <div className="p-8 text-center text-gray-500 font-inter">Loading Waiters...</div>;
    }
    ...
    return (
        <div className="font-inter bg-[#F8F9FB] min-h-[calc(100vh-64px)] md:-m-8 flex flex-col">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-4 md:p-6 rounded-2xl border border-gray-100 shadow-sm flex-wrap">
                        <div>
                            <div className="flex items-center text-[13px] font-medium text-gray-500 mb-2">
                                ...
                                <span className="text-gray-900 font-bold">Waiters</span>
                            </div>
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="border-b border-gray-100">
                                        <th className="py-4 px-6 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Waiter</th>
                                        <th className="py-4 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Employee ID</th>
                                        <th className="py-4 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Phone</th>
                                        <th className="py-4 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Section</th>
                                        <th className="py-4 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Status</th>
                                        <th className="py-4 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Current Table(s)</th>
                                        <th className="py-4 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center">Orders Today</th>
                                        <th className="py-4 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-right">Sales Today</th>
                                ...
                                <tbody>
                                    {filteredWaiters.length > 0 ? filteredWaiters.map((waiter) => (
                                        <tr 
                                            ...
                                            className={`border-b border-gray-50 cursor-pointer transition-colors ${selectedWaiter?.id === waiter.id ? 'bg-indigo-50/50' : 'hover:bg-gray-50'}`}
                                        >
                                            <td className="py-3 px-6">
                                                <div className="flex items-center">
                                                    <img src={waiter.avatar} alt="Avatar" className="w-9 h-9 rounded-full mr-3 border border-gray-200" />
                                                    <span className="text-[13px] font-bold text-gray-900">{waiter.first_name} {waiter.last_name}</span>
                                                </div>
                                            </td>
                                            <td className="py-3 px-4 text-[13px] font-semibold text-gray-600">{waiter.employee_code || `WT00${waiter.id}`}</td>
                                            <td className="py-3 px-4 text-[13px] font-medium text-gray-600">{waiter.phone || '-'}</td>
                                            <td className="py-3 px-4 text-[13px] font-medium text-gray-600">{waiter.section}</td>
                                            ...
                                            <td className="py-3 px-4 text-[13px] font-bold text-gray-700">{waiter.currentTables}</td>
                                            <td className="py-3 px-4 text-[13px] font-bold text-gray-700 text-center">{waiter.ordersToday}</td>
                                            <td className="py-3 px-4 text-[13px] font-bold text-gray-900 text-right">
                                        ...
                                        <tr>
                                            <td colSpan="9" className="py-8 text-center text-[13px] text-gray-500 font-medium">
                        ...
                        <div className="p-4 border-t border-gray-100 flex items-center justify-between bg-white rounded-b-2xl">
                            ...
                            <div className="flex items-center space-x-4">
                                <div className="flex items-center space-x-1">
                                    <button className="p-1.5 rounded-lg border border-gray-200 text-gray-400 hover:bg-gray-50"><ChevronLeft size={16}/></button>
                                    <button className="w-8 h-8 rounded-lg bg-indigo-600 text-white text-[13px] font-bold">1</button>
                                    <button className="w-8 h-8 rounded-lg border border-gray-200 text-gray-600 text-[13px] font-bold hover:bg-gray-50">2</button>
                                    <button className="p-1.5 rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-50"><ChevronRight size={16}/></button>
                                </div>
                                <div className="flex items-center text-[12px] font-semibold text-gray-500">
                                    Rows per page: 
                                    <select className="ml-2 bg-transparent font-bold text-gray-700 outline-none">
                                        <option>10</option>
                                        <option>20</option>
                                        <option>50</option>
                                    </select>
            ...
            <div className={`fixed top-0 right-0 h-full w-full sm:w-[380px] bg-white border-l border-gray-100 shadow-2xl transform transition-transform duration-300 ease-in-out z-20 ${selectedWaiter ? 'translate-x-0' : 'translate-x-full'}`}>
                {selectedWaiter && (
                    <div className="h-full flex flex-col">
                        <div className="flex items-center justify-between p-6 border-b border-gray-100 shrink-0">
                            <h2 className="text-[15px] font-bold text-gray-900">Waiter Details</h2>
                            <button onClick={() => setSelectedWaiter(null)} className="text-gray-400 hover:text-gray-600 bg-gray-50 hover:bg-gray-100 p-1.5 rounded-lg transition-colors">
                                <X size={20} />
                            </button>
                        </div>
                        ...
                        <div className="p-6 overflow-y-auto flex-1 scrollbar-hide space-y-8">
                            ...
                            <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-[12px] font-semibold text-gray-500 mt-1">Waiter ID: {selectedWaiter.employee_code || `WT00${selectedWaiter.id}`}</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center text-[13px]">
                                    ...
                                    <span className="font-semibold text-gray-500 w-24">Phone</span>
                                    <span className="font-bold text-gray-900 flex-1 text-right">{selectedWaiter.phone || '-'}</span>
                                </div>
                                <div className="flex items-center text-[13px]">
                                    <Mail size={16} className="text-gray-400 mr-3 shrink-0" />
                                    <span className="font-semibold text-gray-500 w-24">Email</span>
                                    <span className="font-bold text-gray-900 flex-1 text-right truncate">{selectedWaiter.email}</span>
                                </div>
                                <div className="flex items-center text-[13px]">
                                    <MapPin size={16} className="text-gray-400 mr-3 shrink-0" />
                                    <span className="font-semibold text-gray-500 w-24">Section</span>
                                    <span className="font-bold text-gray-900 flex-1 text-right">{selectedWaiter.section}</span>
                                </div>
                                <div className="flex items-center text-[13px]">
                                    <Clock size={16} className="text-gray-400 mr-3 shrink-0" />
                                    <span className="font-semibold text-gray-500 w-24">Shift</span>
                                    <span className="font-bold text-gray-900 flex-1 text-right">{selectedWaiter.shift}</span>
                                </div>
                                <div className="flex items-center text-[13px]">
                                    <Calendar size={16} className="text-gray-400 mr-3 shrink-0" />
                                    <span className="font-semibold text-gray-500 w-24">Joined On</span>
                                    <span className="font-bold text-gray-900 flex-1 text-right">{selectedWaiter.joinedOn}</span>
                                </div>
                            </div>
                            ...
                            {/* Current Assignment */}
                            <div>
                                <h4 className="text-[13px] font-bold text-gray-900 mb-4">Current Assignment</h4>
                                <div className="space-y-3">
                                    <div className="flex items-center text-[13px]">
                                        <span className="font-semibold text-gray-500 flex-1 flex items-center">
                                            <div className="w-4 h-4 bg-gray-100 rounded mr-2 flex items-center justify-center"><ClipboardList size={10} className="text-gray-500"/></div>
                                            Table(s)
                                        </span>
                                        <span className="font-bold text-gray-900">{selectedWaiter.currentTables}</span>
                                    </div>
                                    <div className="flex items-center text-[13px]">
                                        <span className="font-semibold text-gray-500 flex-1 flex items-center">
                                            <div className="w-4 h-4 bg-gray-100 rounded mr-2 flex items-center justify-center"><Users size={10} className="text-gray-500"/></div>
                                            Guests
                                        </span>
                                        <span className="font-bold text-gray-900">{selectedWaiter.currentTables !== '-' ? '6 + 4' : '-'}</span>
                                    </div>
                                    <div className="flex items-center text-[13px]">
                                        <span className="font-semibold text-gray-500 flex-1 flex items-center">
                                            <div className="w-4 h-4 bg-gray-100 rounded mr-2 flex items-center justify-center"><Clock size={10} className="text-gray-500"/></div>
                                            Assigned At
                                        </span>
                                        <span className="font-bold text-gray-900">{selectedWaiter.currentTables !== '-' ? '10:05 AM' : '-'}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Today's Performance */}
                            <div>
                                <h4 className="text-[13px] font-bold text-gray-900 mb-4">Today's Performance</h4>
                                <div className="grid grid-cols-4 gap-2">
                                    <div className="bg-gray-50 rounded-xl p-3 text-center border border-gray-100">
                                        <h5 className="text-[15px] font-black text-gray-900">{selectedWaiter.ordersToday}</h5>
                                        <p className="text-[9px] font-semibold text-gray-500 mt-1 uppercase tracking-wider">Orders</p>
                                    </div>
                                    <div className="bg-gray-50 rounded-xl p-3 text-center border border-gray-100">
                                        <h5 className="text-[14px] font-black text-gray-900">₹ {selectedWaiter.salesToday > 1000 ? (selectedWaiter.salesToday/1000).toFixed(1)+'k' : selectedWaiter.salesToday}</h5>
                                        <p className="text-[9px] font-semibold text-gray-500 mt-1 uppercase tracking-wider">Sales</p>
                                    </div>
                                    <div className="bg-gray-50 rounded-xl p-3 text-center border border-gray-100 flex flex-col items-center">
                                        <div className="flex items-center justify-center text-[13px] font-black text-gray-900">
                                            {selectedWaiter.rating} <Star size={10} className="ml-0.5 text-yellow-400 fill-current" />
                                        </div>
                                        <p className="text-[9px] font-semibold text-gray-500 mt-1 uppercase tracking-wider">Rating</p>
                                    </div>
                                    <div className="bg-gray-50 rounded-xl p-3 text-center border border-gray-100">
                                        <h5 className="text-[15px] font-black text-gray-900">{selectedWaiter.tips}</h5>
                                        <p className="text-[9px] font-semibold text-gray-500 mt-1 uppercase tracking-wider">Tips</p>
                                    </div>
                                </div>
                            </div>
                        </div>
